...
<head>
  ...
  <link href="logo pln.png" rel="apple-touch-icon"/>
  <link href="logo pln.png" rel="shortcut icon" type="image/x-icon"/>
...
<div class="loading"><div class="spinner-border text-primary" role="status"></div></div>
  <!-- loader -->
    <div id="loader">
        <img src="'.$site_url.'/mod/assets/img/logo pln.png" alt="icon" class="loading-icon">
    </div>
    <!-- * loader -->';
