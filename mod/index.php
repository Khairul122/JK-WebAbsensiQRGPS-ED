...
?>
	...
	<head>
		...
		<link href="<?php echo $site_url; ?>/logo pln.png" rel="apple-touch-icon" />
		<link href="<?php echo $site_url; ?>/logo pln.png" rel="shortcut icon" type="image/x-icon" />
						...
						<div class="row h-100 justify-content-center align-items-center">
							<div class="col-lg-5">
								<div class="hero-content text-center text-white">
									<p>
										<img src="logo pln.png" class="img-fluid" width="180px">
									</p>
